...
class ImageEditorApp:
    def __init__(self, root):
        ...
        self.complement_button = tk.Button(root, text="Color Complement", command=self.color_complement)
        self.complement_button.grid(row=1, column=3, pady=5)
        
        self.show_hist_button = tk.Button(root, text="Show Histogram", command=self.display_histograms)
        self.show_hist_button.grid(row=2, column=3, pady=5)

        self.rgb_equalization = tk.Button(root, text="RGB Equalization", command=self.equalization)
        self.rgb_equalization.grid(row=3, column=3, pady=5)

        self.ss_button = tk.Button(root, text="Smooth and Sharp", command=self.smooth_sharp)
        self.ss_button.grid(row=1, column=4, pady=5)

        self.blue_segmentation = tk.Button(root, text="Feather segmentation", command=self.segmentation)
