...
class ImageEditorApp:
    def __init__(self, root):
        ...
        # Ask for the value a
        self.a_label = tk.Label(root, text="a (for contrast and resize)")
        self.a_entry = tk.Entry(root, width=10)

        # Ask for the value b
        self.b_label = tk.Label(root, text="b (for contrast and resize)")
        ...
        # Rotation
        self.rotate_label = tk.Label(root, text="Angle (for rotate)")
        ...
        # Histogram_canvas
        self.histogram_canvas = tk.Canvas(root, width=300, height=200)
        ...
        self.apply_smoothing_button = tk.Button(root, text="Smooth", command=self.apply_smoothing)
        self.apply_sharpening_button = tk.Button(root, text="Sharpen", command=self.apply_sharpening)
